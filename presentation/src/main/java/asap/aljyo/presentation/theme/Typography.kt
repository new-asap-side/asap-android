...
@Composable
fun independentTypography(): AljyoTypography {
...
val LocalAljyoTypography = staticCompositionLocalOf {
    AljyoTypography(
        ...
        b5 = TextStyle.Default,
        b6 = TextStyle.Default,
        b7 = TextStyle.Default,
        c1 = TextStyle.Default,
        c2 = TextStyle.Default,
        c3 = TextStyle.Default,
    )
}